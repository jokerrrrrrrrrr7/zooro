...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1765160742,1003237899,1176590892}
print([[
...
var = "مبرمج السورس"
elseif tonumber(user_id) == tonumber(1198418838) then  
var = "مطور السورس"
...
keyboard.inline_keyboard = {
{
{text = '𝗖𝗛𝗔𝗡𝗡𝗘𝗟 𝗦𝗨𝗥𝗨𝗦', url="http://t.me/SOURCE_ZORO_plus"},
...
download_to_file('https://raw.githubusercontent.com/jokerrrrrrrrrr7/zooro/main/Tshake.lua', 'Tshake.lua') 
download_to_file('https://raw.githubusercontent.com/jokerrrrrrrrrr7/zooro/main/start.lua', 'start.lua') 
dofile('Tshake.lua')  
return false
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝗖𝗛𝗔𝗡𝗡𝗘𝗟 𝗦𝗨𝗥𝗨𝗦',url="t.me/SOURCE_ZORO_plus"}},
}
...
if text == 'بهجت' or text == 'عبدالله بهجت' or text == 'bahjat' then
local Text = [[
...
ـ•–––––––––☆–––––––––•ـ
اختـر الامـر الذي تريـده مـن الأسـفـل.๛

ᴄʜᴀɴᴇʟ ➳ [ sᴏᴜʀᴄᴇ ᴢᴏʀᴏ](https://t.me/SOURCE_ZORO_plus)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
๛╿السيلفي
«|■□■□■□■□■□■□■□■|»
ᴄʜ » [ sᴏᴜʀᴄᴇ ᴢᴏʀᴏ](https://t.me/SOURCE_ZORO_plus)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
